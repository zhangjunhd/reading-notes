...
## 引言 人生就是漫长的练习
所谓`练习`，就是怀着实现某个既定目标的有意的意识与意图，来反复参加某项活动。
...
## 第6章 4“S”方法
所谓的`4“S”方法`，是指四个以“S”开头的英文字母，它们是：简化（simplify）、细分（small）、缩短（short）和放慢（slow）。
...
**重要的是有意识地致力于调整你与观察者之间的一致。出于这一目的，我使用一种有效的冥想附属方法，称为DOC，它是“做、观察和纠正”（do、observe、correct）这三个词的首字母缩写。**
