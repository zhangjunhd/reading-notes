...
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/3313940.jpg)
...
#### ANOVA的检验统计量
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/76061139.jpg)

#### 第一类误差和多假设检验
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/42558943.jpg)

### 方差分析的逻辑
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/80205981.jpg)
...
#### F分数
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/86028158.jpg)
...
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/45624126.jpg)

#### ANOVA公式
1. ANOVA的最终计算是F分数，这个分数由两个方差组成：F=处理间方差/处理内方差
2. 样本数据的方差可以定义为：样本方差=$s^2=\frac{SS}{df}$

![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/1939832.jpg)

#### 平方和的计算
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/3751816.jpg)
...
3. 处理间平方和，$SS_{between}$
    ...
    3. 表13.2中的数据，样本平均数分别为1、4和1，并且n=5.如下列出了$SS_{between}$的计算：![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/28051543.jpg)
...
3. 处理间自由度，$df_{between}$。
    1. 处理的个数是由特定的字母k来表示，那么df的公式是：$df_{between}=k-1\ (13.11)$
    2. 以表13.2中的数值为例，有三个不同的处理条件（三个T值），所以，处理间自由度可以这样计算：$df_{between}=3-1=2$
    3. 注意，从这个自由度的分析中，我们可以得出相加等于总的自由度的两部分：$df_{total}=de_{error}+df_{between}$即14=12+2。图13.7给出了完整的自由度分析。![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/94794685.jpg)
...
![](http://ou8qjsj0m.bkt.clouddn.com//17-10-26/12520307.jpg)
