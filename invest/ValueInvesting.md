...
$R=(1+\bar{ROE})×\sqrt[t]{\frac{PB_t}{PB_0}}-1$

公式一被称为`“ROE-PB”模型`，该公式描述了4个变量之间的关系，首先是投资者的持有期年化投资回报率R，公式中有3个参数，
...
$P=\frac{E_1}{1+r}+\frac{E_1(1+g)}{(1+r)^2}+\cdots+\frac{E_1(1+g)^{i-1}}{(1+r)^i}+\frac{E_1(1+g)^i}{(1+r)^{i+1}}$ (a)

该式两边同时乘以$\frac{1+r}{1+g}$，得到：

$P×\frac{1+r}{1+g}=\frac{E_1}{1+g}+\frac{E_1}{(1+r)}+\frac{E_1(1+g)}{(1+r)^2}+\cdots+\frac{E_1(1+g)^{i-1}}{(1+r)^i}$ (b)

将式（b）与式（a）左右两边同时相减，得到：
