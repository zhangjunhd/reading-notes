...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets1.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets2.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets3.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets4.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets5.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets6.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets7.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets8.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets9.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets10.png" width="700"/>
...
#### 5.5.2 货币供给的变动
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets11.png" width="700"/>
...
<img src="TheEconomicsOfMoneyBankingAndFinancialMarkets12.png" width="700"/>
...
收益率曲线可以分为向上倾斜的、平坦的和向下倾斜的（最后一种通常被称为反转的收益率曲线（inverted yield curve））等三类。如果收益率曲线是向上倾斜的，这是最为常见的情况，那么这种债券的长期收益率将会高于其短期收益率；如果收益率曲线是平坦的，就像金融新闻解读专栏中所显示的那样，那么这种债券的长期收益率将会等于其短期收益率；如果收益率曲线是反转的，那么这种债券的长期收益率将会低于其短期收益率。

#### 6.2.1 预期理论
利率期限结构的`预期理论（expectation theory）`表述了下列常识性命题：长期债券的利率等于在长期债券到期期限内短期利率的平均预期值。举例来说，如果人们预期在未来的5年中短期利率的平均值为10%，那么预期理论认为剩余期限为5年的长期债券利率也应该是10%。如果在这5年后，预计短期利率将会进一步提高，在接下来的20年中短期利率的平均值为11%，那么剩余期限为20年的长期债券利率也应该为11%，高于剩余期限为5年的长期债券利率。从中我们可以发现，预期理论认为具有不同期限的债券利率之间存在差异的原因是未来短期利率预期值不同。

#### 6.2.2 市场分割理论
率期限结构的`市场分割理论（segmented markets theory）`是将具有不同期限债券的市场完全独立和相互分割。具有不同期限的每种债券利率取决于该债券的供求数量，与其期限存在差异的其他种类的预期收益率和该债券的利率之间没有联系。

市场分割理论的一个关键性假设是，具有不同期限的各种债券之间完全不能相互替代。

具有不同期限的债券之间不能够相互替代的原因在于，投资者只对具有特定期限的债券表示出强烈的偏好，而对其他期限的债券不感兴趣，因此他们只会关注自己偏好的那种债券的预期收益率。由于投资者的思维中存在一个特定的持有期限，如果某种债券的期限能够与这个符合投资者意愿的持有期限相匹配，那么投资者就可以在完全无风险的条件下获得特定的收益率（在第4章中我们发现，如果债券的持有期等于债券期限，由于收益率等于到期收益率，所以收益率是固定的，不存在利率风险），故而就会出现债券市场分割的情况。举例来说，如果你为自己年幼的子女积攒大学学费，那么符合你意愿的持有期就会很长，而你将希望持有长期债券。

#### 6.2.3 流动性溢价理论与期限优先理论
利率期限结构的`流动性溢价理论（liquidity premium theory）`认为，长期债券的利率等于长期债券到期期限之内的短期利率的平均预期值加上随该债券供求状况变动而改变的流动性溢价（也称`期限溢价`）。

流动性溢价理论的关键假设是，具有不同期限的债券之间可以相互替代，这意味着某种债券预期收益率能够影响其他期限债券的预期收益率，然而该理论允许投资者对具有不同期限的各种债券存在偏好。换言之，该理论假设具有不同期限的债券之间是可以相互替代的，但不是完全相互替代。由于短期债券的利率风险相对较小，所以投资者通常偏好于短期债券。由于上述原因，投资者必须能够获得正的流动性溢价才会选择持有长期债券。

同流动性溢价理论密切相关的是`期限优先理论（preferred habitat theory）`，期限优先理论假设投资者偏好特定的债券期限，更愿意对这种特定期限（期限优先）的债券进行投资。由于投资者偏好特定期限的债券，所以只有在其他期限债券具有更高预期收益率的条件下，投资者才会选择购买这些债券。

## 第7章 股票市场、理性预期理论和有效市场假说
### 7.1 普通股股票价格的计算
发行普通股股票是公司筹集股权资本的一个主要途径。普通股股票的持有者享有公司的权益，份额等于其持有的未赎回股份占总股份的百分比。这种对公司权益的所有权赋予`股东（shareholders，公司股票的持有者）`一系列的权利。其中最重要的是投票权和对流入公司全部资金（即现金流（cash flow））的`剩余求偿权（residual claimant）`，后者意味着股东享有公司资产在偿付其他全部求偿权之后所有剩余部分的求偿权。股东可以从公司的净收益中获得红利收入。股东获得的`红利（dividends）`是定期支付的，一般按季度进行。

#### 7.1.1 单期估值模型
如果你拥有一笔额外资金可以进行1年期投资活动。1年后，你将出售这笔投资工具来支付学费。在观看了美国全国广播公司财经频道（CNBS）或者电视台《晚间经济报道》等媒体报道后，你决定购买英特尔公司的股票。你给股票经纪人打电话，得知英特尔公司现在的股价是50美元，红利为每年0.16美元。美国全国广播公司财经频道的分析专家预计1年后英特尔公司的股票价格将达到60美元，你应该购买这只股票吗？

为了回答这个问题，你必须了解该股票的现期价格是否准确反映了分析专家的预期结论。现金流是由一次的红利支付金额和最终的销售价格构成的。在计算这些现金流的现值时，利用下述公式能够计算出股票的现期价格：

$P_0=\frac{Div_1}{1+k_e}+\frac{P_1}{1+k_e}$(7-1)

式中，$P_0$为股票的现期价格，下标0代表了时间点0，即现在；$Div_1$为第1年年末获得的红利；$k_e$为该项股权投资的要求收益率；$P_1$为第1阶段末的股票价格，即股票的预期售价。

你将满足于从该项投资中获得12%的要求收益率，让我们计算英特尔公司股票的价格。如果你确定$k_e$=12%，并且得知英特尔公司每年支付的红利金额为0.16美元（$Div_1$=0.16），而1年后的股票价格预计为60美元（$P_1$=60美元）。根据式（7-1），你将会得到：

$P_0=\frac{0.16}{1+0.12}+\frac{60}{1+0.12}=0.14+53.57=53.71$

根据上述分析结果，你将会发现该项股票投资产生全部现金流的折现值为53.71美元，由于现在该股票的售价为50美元，所以你会购买这只股票。

#### 7.1.2 推广的红利估值模型
使用现值的概念，可以将单期红利估值模型推广为任意时期的估值模型：某种股票的现期价值等于所有未来现金流的现值。投资者能够获得的现金流仅仅是红利收益和在第n期末出售股票的最终价格。多期的一般性股票估值公式亦可写为：

$P_0=\frac{D_1}{(1+k_e)}+\frac{D_2}{(1+k_e)^2}+\cdots+\frac{D_n}{(1+k_e)^n}+\frac{P_n}{(1+k_e)^n}$(7-2)

如果使用式（7-2）计算股票的价值，你将会很快意识到必须首先估计到在未来某个时点上的股票价值，然后才能够计算它的现期价值。然而，如果Pn是在很遥远的未来才出现的，那么它对于P0的影响就可以忽略不计。举例来说，如果距现在75年后股票的价格为50美元而贴现率为12%，那么该股票的现期价值仅为1美分（50美元（/$1.12^{75}$）=0.01美元）。这个推论意味着股票的现期价值可以简化为未来全部红利收益的现值。排除股票最终销售价格后，`推广的红利估值模型（generalized dividend model）`可以重新写为：

$P_0=\sum_{\infty}^{t=1}\frac{D_t}{(1+k_e)^t}$(7-3)

考察式（7-3）的含义。推广的红利估值模型认为股票的价值仅仅取决于未来红利的现值，而与其他因素无关。然而，许多股票并不派发红利，那么它们的价值应该如何计算呢？股票的购买者预计在未来某一时刻公司将会派发红利。在大多数情况下，在其生命周期的快速增长阶段结束后公司都会派发红利。
