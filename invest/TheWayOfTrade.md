...
中线也叫`波段`。大家可以把K线图拉开来看，波段清晰的个股的特点是什么？是高低点的变换节奏非常有规律。
...
因为在我的交易哲学里，我认为市场是错的。如果市场是错的，那我永远都在猜测，或者说是在度量和感受市场相应的拐点，在这些拐点上，去进行一些操作。在识别拐点的时候，我用的是背离，用MACD（指数平滑异同移动平均线）指标。当价格出新高，MACD没出新高，我认为这是`顶背离`；当价格出新低，MACD没出新低，我认为是`底背离`。判断MACD是高还是低，我用DIF（差离值）指标，这个指标是用长的减短的或者用短的减长的，取的是绝对值，我把这个指标稍微修正一下，变成一个相对数，然后在软件上乘以10 000，放大1万倍，让它看起来更清晰。
